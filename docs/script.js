...
function guardarUsuario(e) {
    ...
    if (tipo === "inspector") {
        usuario.nombre = document.querySelector('[name="nombre"]').value;
        usuario.licencia = document.querySelector('[name="licencia"]').value;
        usuario.especialidad = document.querySelector('[name="especialidad"]').value;
    }
    ...
    // 1. AGREGAR A LA LISTA Y GUARDAR
...
// ==============================
// 🌙 MODO OSCURO (si existe el botón en la página)
// ==============================
...
// =========================================================================
// 🤖 ASIGNACIÓN INTELIGENTE DE INSPECTORES (GitHub / Automático / Manual)
// =========================================================================
...
// =========================================================================
// 🎯 GUARDAR SOLICITUD DESDE EL PORTAL
// =========================================================================
